...
async function collectLiveAssetRefs(orgId) {
  ...
  // BUILD-94 Part 1 — donor photos are the first pointer in the product that
  // stores a BARE asset id rather than a /portal-assets/ path (they are served
  // through the signed /person-photos front door instead). If they were not
  // on this list the 90-day purge would destroy the face on a live profile,
