...
export const SC = { major:"#10b981",mid:"#3b82f6",new:"#8b5cf6",lapsed:"#f59e0b",converted:"#10b981",active:"#10b981",pending:"#3b82f6",prospecting:"#8b5cf6",closed:"#6b7280",high:"#ef4444",medium:"#f59e0b",low:"#6b7280" };
...
export const TIER_COLOR = {Micro:"#6b7280",Small:"#3b82f6",Mid:"#10b981",Major:"#8b5cf6",Principal:"#f59e0b"};
